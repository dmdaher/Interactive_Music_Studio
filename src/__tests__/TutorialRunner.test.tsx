...
describe('TutorialRunner', () => {
  it('renders header with tutorial title/category/difficulty', () => {
    render(<TutorialRunner tutorial={testTutorial} DevicePanel={MockDevicePanel} panelWidth={2200} panelHeight={540} />);
  ...
  it('no max-w-5xl constraint on panel container', () => {
    const { container } = render(
      <TutorialRunner tutorial={testTutorial} DevicePanel={MockDevicePanel} panelWidth={2200} panelHeight={540} />,
    );
