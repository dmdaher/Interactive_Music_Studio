  ...
  return (
    <div className="flex items-end gap-1 px-2 py-1">
      <div className="flex flex-col items-center gap-0.5">
        ...
        <PanelButton id={`${d}-in`} label="" variant="function" size="sm"
      ...
      <div className="flex flex-col items-center gap-0.5">
        ...
        <PanelButton id={`${d}-out`} label="" variant="function" size="sm"
      ...
      <div className="flex flex-col items-center gap-0.5 ml-2">
        ...
        <PanelButton id={`${d}-beat-sync`} label="BEAT SYNC" variant="function" size="md"
